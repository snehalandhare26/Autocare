import { Mail, Phone, MapPin, Facebook, Instagram, Twitter, Wrench } from 'lucide-react';
...
export const Footer = () => {
  ...
  const services = [
    ...
    { name: 'Tyres & Balancing', href: '#services' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-white text-lg font-bold">{siteConfig.name}</h3>
            </div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href={`tel:${siteConfig.phone}`} className="text-sm hover:text-white transition-colors">
                  {siteConfig.phone}
                </a>
              </li>
              <li className="flex items-center space-x-3">
